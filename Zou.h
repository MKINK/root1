...
// Thu Nov  2 08:49:50 2023 by ROOT version 6.26/10
// from TTree tr/data tree
// found on file: run00074_final.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxdata_XIA = 11;
...
#ifdef Zou_cxx
Zou::Zou(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run00074_final.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run00074_final.root");
      }
      f->GetObject("tr",tree);
...
Int_t Zou::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Zou::LoadTree(Long64_t entry)
{
