...
// Mon Dec 18 17:03:54 2023 by ROOT version 6.26/10
// from TTree tree/tree
// found on file: kd&store39.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("kd&store39.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("kd&store39.root");
      }
