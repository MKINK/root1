...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Short_t kMaxdata_XIA = 127;
...
Int_t gama::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gama::LoadTree(Long64_t entry)
{
